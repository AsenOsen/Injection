...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE prev, LPTSTR cmdline, int nMode)
{
	...
	edit = CreateWindowEx(NULL,"Edit",appname, WS_CHILD | WS_VISIBLE | WS_BORDER, 0,0,100,20,hWnd,NULL,hInstance,NULL);
	button = CreateWindowEx(NULL,"Button","Inject!", WS_CHILD | WS_VISIBLE, 0,20,100,20,hWnd,NULL,hInstance,NULL);
